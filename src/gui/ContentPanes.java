...
public class ContentPanes extends JPanel {
	
	public ContentPanes(String title, String[] labels, String[] fields) {
        // create labels
		JLabel[] labelList = new JLabel[labels.length];
        for(int i = 0; i < labels.length; i++) {
        	labelList[i] = new JLabel(labels[i]);
        }
        // create fields
        JTextField[] fieldList = new JTextField[fields.length];
